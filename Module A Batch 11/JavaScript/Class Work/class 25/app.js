...
for (const fKey in mobiles) {
  // console.log(mobiles[fKey])
  for (const sKey in mobiles[fKey]) {
    // console.log(mobiles[fKey][sKey])
    for (const tKey in mobiles[fKey][sKey]) {
      // console.log(mobiles[fKey][sKey][tKey])
      for (const foKey in mobiles[fKey][sKey][tKey]) {
        // console.log(mobiles[fKey][sKey][tKey][foKey])
        for (const fvKey in mobiles[fKey][sKey][tKey][foKey]) {
          // console.log(mobiles[fKey][sKey][tKey][foKey][fvKey])
          for (const sixKey in mobiles[fKey][sKey][tKey][foKey][fvKey]) {
            // console.log(mobiles[fKey][sKey][tKey][foKey][fvKey][sixKey])
            for (const sevKey in mobiles[fKey][sKey][tKey][foKey][fvKey][
              sixKey
            ]) {
                // console.log(
                //   mobiles[fKey][sKey][tKey][foKey][fvKey][sixKey][sevKey]
                // );
            }
          }
        }
